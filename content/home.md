<div class="hero">
<div class="hero-top">
<h1 class="hero-title" id="top">Marco Fissore <span class="accent">'27</span></h1>
<div class="hero-socials">
<a href="https://www.printables.com/@MarsRider_607948" target="_blank" rel="noopener" title="Printables"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--text)" class="bi bi-link" viewBox="0 0 16 16">
...
<a href="https://www.instagram.com/marcofix.01/" target="_blank" rel="noopener" title="Instagram"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--text)" class="bi bi-instagram" viewBox="0 0 16 16">
...
<a href="https://github.com/Mars-Rider" target="_blank" rel="noopener" title="GitHub"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--text)" class="bi bi-github" viewBox="0 0 16 16">
  <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8"></path>
</svg></a>
<a href="https://www.flickr.com/photos/198914131@N02/" target="_blank" rel="noopener" title="Flickr"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--text)" class="bi bi-link" viewBox="0 0 16 16">
  <path d="M6.354 5.5H4a3 3 0 0 0 0 6h3a3 3 0 0 0 2.83-4H9q-.13 0-.25.031A2 2 0 0 1 7 10.5H4a2 2 0 1 1 0-4h1.535c.218-.376.495-.714.82-1z"></path>
  <path d="M9 5.5a3 3 0 0 0-2.83 4h1.098A2 2 0 0 1 9 6.5h3a2 2 0 1 1 0 4h-1.535a4 4 0 0 1-.82 1H12a3 3 0 1 0 0-6z"></path>
</svg></a><a href="https://www.strava.com/athletes/137689175" target="_blank" rel="noopener" title="Strava"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--text)" class="bi bi-strava" viewBox="0 0 16 16">
...
<a href="https://www.linkedin.com/in/marco-fissore-6845a3382/" target="_blank" rel="noopener" title="Linked In"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--text)" class="bi bi-linkedin" viewBox="0 0 16 16">
...
> **AI Disclaimer** A majority of this sites styles and javascript has been generated with AI with editing done by me, though all the content, from photos to projects to articles, are 100% made by me unless stated otherwise with a AI disclaimer similar to this
